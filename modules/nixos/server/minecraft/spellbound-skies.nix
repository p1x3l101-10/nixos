...

{
    ...
    settings = {
      ...
      java = {
        ...
        args = [
          ...
          "-Dunsup.bootstrapUrl='https://raw.githubusercontent.com/p1x3l101-10/spellbound-skies/refs/heads/main/unsup.ini'" 
  ...
  # Persist server
  environment.persistence."/nix/host/state/Servers/Minecraft/spellbound-skies".directories = [
